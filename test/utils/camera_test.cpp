...
TEST(CameraTest,
     GivenMultipleCameraIDsAndNoSavedIDExpectIDToBeEqualToFirstCameraID) {
  std::vector<int> camera_ids{0, 1, 2, 3, 4, 5};
...
TEST(CameraTest,
     GivenNoCameraIDsAndSavedIDExpectIDToBeEqualToNoAvailableCameraValue) {
...
TEST(CameraTest,
     GivenNoCameraIDsAndNoSavedIDExpectIDToBeEqualToNoAvailableCameraValue) {
  std::vector<int> camera_ids{};
  std::optional<int> saved_id{std::nullopt};
  const int expected_id{-1};
